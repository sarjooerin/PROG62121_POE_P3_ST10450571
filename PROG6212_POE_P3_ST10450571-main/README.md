...
In this update, I’ve focused on enhancing the user experience (UX) and design, ensuring that the process is both efficient and intuitive for users. This README explains the improvements made to the application’s design, usability, and overall flow.
...
1. **Submit Claims**: Lecturers can submit their claims by providing their hours worked, hourly rate, and supporting documents.
2. **Track Status**: After submission, lecturers can track the status of their claims in real time as they move through the approval process.

### For Coordinators and Managers

1. **Review Claims**: Coordinators and managers can view all submitted claims in an easy-to-read table.
2. **Approve or Reject**: They can approve or reject claims directly from the dashboard, leaving optional remarks.
3. **Preview Documents**: Managers can preview uploaded documents inline to verify the claim without needing to download files.
...
By focusing on user-centered design principles, I have made the application more efficient, more accessible, and more reliable, ensuring that users can complete their tasks with minimal frustration and maximum ease.
